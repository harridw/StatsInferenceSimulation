...
```{r population_density_histogram, include = TRUE, echo = TRUE}
...
```{r sample.mean.distribution_hist, include = FALSE, echo = FALSE, results = TRUE}
...
set.seed(100)
vsim = NULL
for (i in 1: nsamp) vsim <- c(vsim, var(rexp(n,lambda)))
```
