...
sample variances for different sample sizes to the theoretical mean and variance.

Let's start with a simple comparison.  If we calculate the mean and variance of a large  
exponential sample population, like 10,000, we would expect this to be fairly close to  
...
plot(sim.mean, type = "l", lwd = 1, col = "black", ylim = c(4,5.5),
     ...
     main = "Sample Mean vs. Theoretical Mean", cex.main = 0.5)
...
plot(sim.var, type = "l", lwd = 1, col = "black",
     xlab = "Number of Simulations",
