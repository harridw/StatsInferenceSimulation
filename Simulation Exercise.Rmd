...
hist(msim, prob = TRUE, breaks = 40,
     xlab = "Sample Mean", xlim = c(1,9),
     main = "Histogram with Distribution of Sample Mean (1,000 Samples")
...
hist(vsim, prob = TRUE, breaks = 40,
     xlab = "Sample Variance", xlim = c(10,40),
     main = "Histogram with Distribution of Sample Variance (1,000 Samples)")
